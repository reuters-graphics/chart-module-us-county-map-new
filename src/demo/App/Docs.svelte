...
<script>
  ...
  // Installation docs
  const installDocs = `$ yarn add https://github.com/reuters-graphics/chart-module-us-county-map-new.git`;

  // JavaScript docs
  $: jsDocs = `import Chart from '@reuters-graphics/chart-module-us-county-map-new';
...
`;
  ...
  // SCSS docs
  const styleDocs = `$CountyMap-container: '.us-county-map-new-container';
...
<div class='repo-link'>
  <a href="https://github.com/reuters-graphics/chart-module-us-county-map-new" target="_blank">
    <Icon icon={faGithub} />
  </a>
</div>
